...
AWS IAM Identity Center (formerly AWS Single Sign-On) is a cloud service that centrally manages **workforce access** to multiple AWS accounts and applications. 
